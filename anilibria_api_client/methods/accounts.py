...
class AccountsMethod(BaseMethod):
    ...
    async def users_me_collections_releases_get(
        ...
        result = await self._api.get("/accounts/users/me/collections/releases", params=final_params)
    ...
    async def users_me_collections_releases_post(
            ...
            result = await self._api.post("/accounts/users/me/collections/releases", json_data=final_json)
            return UsersMeCollectionsReleasesResponse(**result)
