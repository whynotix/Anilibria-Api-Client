...
from anilibria_api_client.models import ReleaseCollection, CollectionType, ContentType, AgeRating, UsersMeCollectionsReleasesResponse
...
async def test_releases_get_post(
    ...
    releases_get = await anilibria_api_client.accounts.users_me_collections_releases_get(
    ...
    releases_post = await anilibria_api_client.accounts.users_me_collections_releases_post(
        release_collection=ReleaseCollection(
            type_of_collection=CollectionType.PLANNED,
            page=1,
            limit=10,
